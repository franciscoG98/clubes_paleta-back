...
export class CanchaController {
  ...
  static async getAllCanchas(req: Request, res: Response) {
    try {
      const { city, state, type } = req.query;
      // const { club, city, state, type } = req.query;
  ...
  static async getOneCancha(req: Request, res: Response): Promise<void> {
    try {
      const { id } = req.params;
  ...
  // TODO: try update may explode
  // static async updateCancha(req: Request, res: Response) {
  //   // : Promise<void>
  //   try {
  //     const { id } = req.params;
  ...
  static async deleteCancha(req: Request, res: Response): Promise<void> {
